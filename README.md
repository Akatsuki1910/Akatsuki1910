...
[![My Skills](https://skillicons.dev/icons?i=arch,arduino,astro,babel,bash,blender,bootstrap,c,cs,cloudflare,css,dart,debian,discord,bots,discordjs,docker,electron,emotion,express,fastapi,figma,firebase,flutter,gcp,git,github,githubactions,gmail,grafana,graphql,html,java,js,jest,jquery,kotlin,latex,linux,md,materialui,nextjs,nginx,nodejs,npm,nuxtjs,p5js,ps,planetscale,pnpm,postman,prisma,processing,pug,py,pytorch,raspberrypi,sass,styledcomponents,sublime,supabase,svelte,svg,tensorflow,threejs,twitter,ts,ubuntu,vercel,vite,vscode,vue,wasm,webpack,windows,yarn)](https://skillicons.dev)
